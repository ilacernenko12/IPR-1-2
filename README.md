## Javascript Assignments  [![Build Status](https://app.travis-ci.com/ilacernenko12/js-assignments.svg?branch=master)](https://app.travis-ci.com/ilacernenko12/js-assignments)
...
* Edit local README.md file and update all links (just replace all occurrences of `'ilacernenko12'` with your account name).
...
```
* Open https://github.com/ilacernenko12/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
...
* Push your updates to github server and check if tests passed on [travis-ci](https://travis-ci.org/ilacernenko12/js-assignments/builds).
